...
const SCENES = {
  '0-cover': {
    ...
    prompt: `BOOK COVER, composed so everything sits in the UPPER part of the image (square-friendly). Across the TOP, the title in warm rounded hand-lettered storybook letters: "The New Little Light". Directly below the title, the WHOLE family grouped CLOSE TOGETHER and centered, filling the frame with little empty space: MOM (golden adult unicorn, lavender mane, small gold heart necklace) and DAD (a big but friendly, soft-bodied bronzed-green adult dragon — NOT muscular, no abs) behind, with IVY (white child unicorn, purple mane, feathered wings) and OLIVER (green child dragon, orange spots, orange heart chest patch) in front, and the tiny PINK baby unicorn (rose mane, gold-glowing horn) held up in the very middle so she is clearly visible. The whole family glowing softly together, cozy and magical. There is exactly ONE unicorn child (Ivy) and exactly ONE dragon child (Oliver, a GREEN DRAGON — NOT a unicorn); do not draw two unicorn children.` + SCENE_STYLE,
  },
  '0-intro': {
    refDir: THUMBS, outDir: BOOK8, out: '0-intro.png',
    refs: ['mom-pregnant.png', 'ivy.png', 'oliver.png'],
    prompt: `Cozy sunlit living room. MOM, a golden four-legged unicorn (lavender mane, gold heart necklace, soft shawl), is STANDING on all four hooves. Like a pregnant mare, her big round PREGNANT belly hangs LOW on her underside, between her four legs (the swelling is underneath her barrel/torso, not sticking out forward from her chest) — match the low-hanging belly in the reference image; she is heavily pregnant. She has hooves, no hands or arms. IVY (white child unicorn, purple mane, wings) beaming with excitement beside her. OLIVER (green child dragon, orange spots, orange heart chest patch) crouching down to gently press one ear against Mom's low, round pregnant belly to listen, curious but a little unsure. Warm afternoon light, tender and joyful.` + SCENE_STYLE,
  },
  '1': {
    refDir: THUMBS, outDir: BOOK8, out: '1.png',
    refs: ['mom-pregnant.png', 'dad.png', 'ivy.png', 'oliver.png'],
    prompt: `Homey living room, daytime. MOM, a golden adult four-legged unicorn (lavender mane, gold heart necklace, a soft shawl over her back) with a big round pregnant belly, napping peacefully curled on a comfy couch like a resting horse, a cozy blanket tucked over her folded legs so only her head, neck, shoulders, round pregnant belly, and front HOOVES (not hands) show above the blanket. She has hooves and no hands or arms, one normal unicorn head and a single pair of ears. In the kitchen behind, DAD, a tall friendly bronzed-green adult dragon, stirring a pot. IVY (white unicorn, purple mane, wings) sitting patiently holding a little calendar. OLIVER (green dragon child, orange spots, orange heart chest patch), about the same size as Ivy, lying on his tummy on the rug with his chin propped on his paws, looking bored and a bit anxious (normal dragon anatomy, head facing forward). Cozy, gentle waiting mood.` + SCENE_STYLE,
  },
  '2A': {
  ...
  '3A': {
    ...
    refs: ['grandma-quinn.png', 'ivy.png', 'oliver.png'],
    prompt: `A bright, hopeful scene in a cozy room. GRANDMA QUINN is an ELDERLY UNICORN — a four-legged unicorn with a spiral horn, white coat, silver-grey mane, round glasses, a knitted shawl, and NO wings. She is a UNICORN, absolutely NOT a human or person, with hooves not hands. She stands proudly beside a low table holding a lopsided decorated cake, watching over IVY (white unicorn, purple mane, feathered wings) and OLIVER (green dragon, orange spots, heart chest patch) who help her. EXACTLY THREE characters appear in total — Grandma (no wings), Ivy (with wings), and Oliver — with NO extra or duplicate unicorns; each unicorn has exactly four legs, no extra legs. A big colorful paper banner strung above clearly spells the full word "WELCOME". On the table there is ONLY the cake and a few teacups — there is NO baby and no baby figure anywhere in the scene (the baby has not been born yet). Warm, busy, hopeful.` + SCENE_STYLE,
  },
  '3B': {
    refDir: THUMBS, outDir: BOOK8, out: '3B.png',
    refs: ['grandma-quinn.png', 'ivy.png', 'oliver.png'],
    prompt: `A dim, quiet bedroom at night, soft moonlight through the window. TWO children are tucked in side by side under the covers of one bed. IVY (white unicorn, purple mane, wings) looks very sad and homesick — a droopy, downcast face, missing her mom (NO tears, just sad). Beside her, OLIVER (green dragon CHILD, orange spots, orange heart chest patch, the SAME SIZE as Ivy, a big kid not tiny) leans in to comfort his big sister with a brave, kind little smile. GRANDMA QUINN (elderly white four-legged unicorn, silver mane, glasses, shawl — NOT a human) leans over the bed, tucking BOTH children in and hugging them warmly, glowing with warmth. Both the white winged unicorn girl and the green dragon boy are clearly visible in the bed. Tender and comforting.` + SCENE_STYLE,
  },
  '4': {
    refDir: THUMBS, outDir: BOOK8, out: '4.png',
    refs: ['mom.png', 'dad.png', 'baby-sister.png', 'ivy.png', 'oliver.png'],
    prompt: `Warm entryway, the family just home from the hospital. DAD (a tall, soft-bodied, friendly bronzed-green adult dragon — NOT muscular, with a gentle rounded tummy, no defined chest muscles or abs) gently cradling a tiny swaddled newborn PINK baby unicorn (rose mane, tiny gold-glowing horn) with little golden sparkles. MOM — a four-legged UNICORN with a horse-like muzzle and four hooves — stands beside Dad with ALL FOUR of her hooves planted firmly on the floor and her front legs straight down — she is NOT reaching toward, touching, or resting a leg on Dad or the baby, and she smiles warmly toward the baby. She has no arms or hands — her front legs end in HOOVES; exactly four legs, no extra limbs. She has a unicorn face and body (NOT human); she wears a soft shawl draped over her back. Golden coat, lavender mane, gold heart necklace, no longer pregnant. On a small side table, two little wrapped gift boxes. IVY (white unicorn, purple mane, wings) and OLIVER (green dragon, orange spots, heart chest patch) creeping close in wonder; OLIVER pinching his nose as the baby begins to cry. Joyful, funny, brimming with love.` + SCENE_STYLE,
  },
  '5A': {
  ...
  '5B': {
    ...
    prompt: `A tender nighttime moment in warm golden lamplight. DAD — a friendly adult dragon (soft-bodied, NOT muscular, bronzed-green) — sits with a comforting arm around OLIVER. OLIVER (green dragon CHILD, orange spots, orange heart chest patch) leans into Dad with a brave little wobbly smile (not crying, no tears). MOM — a full-grown four-legged unicorn (golden coat, lavender mane, gold heart necklace, soft shawl) standing/resting on her hooves and four legs (NOT human legs or hands) — is close beside them. IVY (white unicorn CHILD, purple mane, wings) leans in close. The tiny newborn PINK baby unicorn is fast ASLEEP, swaddled snugly in a soft blanket, lying in a little woven BASKET on the floor beside them. PROPORTIONS (important): Mom and Dad are grown-ups, clearly much BIGGER than the children; IVY and OLIVER are both CHILDREN of the SAME size (noticeably smaller than the adults); the swaddled baby is tiny. Warm, reassuring, intimate.` + SCENE_STYLE,
  },
  '6': {
    refDir: THUMBS, outDir: BOOK8, out: '6.png',
    refs: ['mom.png', 'dad.png', 'ivy.png', 'oliver.png', 'baby-sister.png'],
    prompt: `A warm, glowing bedtime ending. The whole family is cuddled up together in one big cozy BED, snuggled under a soft patchwork blanket pulled up so it covers their bodies — mostly their heads, shoulders, and happy faces peek out above the covers (their legs and bodies are hidden under the blanket). Tucked in side by side: IVY (white unicorn, purple mane, little wings), MOM (golden unicorn, lavender mane, gold heart necklace), the tiny PINK baby unicorn (rose mane, gold-glowing horn) fast ASLEEP with her eyes closed nestled in the middle, DAD (a big but soft-bodied, friendly bronzed-green dragon — NOT muscular, no defined chest muscles or abs), and OLIVER (green dragon child, orange spots, orange heart chest patch). Everyone cozy, sleepy, and content, with gently closed or droopy happy eyes. Soft warm lamplight. A heartfelt family ending.` + SCENE_STYLE,
  },
};
