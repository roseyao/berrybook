...
const SCENES11 = {
  ...
  'ch5-frozen': {
    ...
    refs: ['ivy.png', 'oliver.png', 'mom.png', 'baby-sister.png'],
    prompt: `Vertical 3:4 portrait, cool pale-blue FROZEN palette with a faint frost shimmer, eerie-still but not scary. A cozy family-home kitchen, but TIME HAS STOPPED — everything frozen mid-motion. MOM (the adult golden-honey four-legged UNICORN from the reference — lavender mane, a gold heart-pendant necklace, horse muzzle and hooves, never humanoid) is frozen leaning toward a high chair, a spoon of orange food held an inch from the open mouth of baby HAZEL — a TINY PINK baby UNICORN (rose-pink coat, rose-pink mane, a little gold-glowing horn-nub) — whose face is scrunched mid-cry with one tear stopped halfway down her cheek. Behind, a pot of soup frozen mid-bubble, and through an oven window a half-risen cake, and on the windowsill a jar with a half-grown sparkling crystal — all caught partway. IVY (the white unicorn) and OLIVER (the emerald-green dragon) stand among it all looking around in amazement, the only two who can move — OLIVER is a BIG KID, the same size as Ivy or only a little shorter, NOT a baby or a toddler, clearly a big child. At the very centre of the floor sits a small BIRD whose bright feathers have gone dull-grey, beak open mid-shout, wrapped in a shell of frost. Exactly FIVE characters — Mom (golden unicorn), baby Hazel (pink unicorn), Ivy, Oliver, and the small grey bird — no duplicates, no extra characters. Ivy a little taller than Oliver. Still, hushed, a little uncanny — not frightening.` + STYLE11,
  },
  'ch5-thaw': {
    refDir: THUMBS, outDir: BOOK11, out: 'ch5-thaw.png', aspectRatio: '1:1',
    refs: ['mom.png', 'baby-sister.png'],
    prompt: `Children's-book watercolor, soft brushstrokes, WARM golden light, cozy and full of life. Square. A family kitchen, un-frozen and moving and alive again: MOM (the adult golden-honey four-legged UNICORN from the reference — lavender mane, gold heart-pendant necklace, horse muzzle and hooves, never humanoid) happily spooning orange food to a smiling, fed baby HAZEL — a TINY PINK baby UNICORN (rose-pink coat, rose mane, a little gold-glowing horn-nub) — in a high chair. A golden finished cake steaming on the counter, and on the windowsill a beautiful fully-grown sparkling CRYSTAL throwing little rainbows across the wall. Everything warm, content, in gentle motion. Exactly TWO characters — Mom (golden unicorn) and baby Hazel (pink unicorn) — no other characters, no duplicates. Cozy and tender.` + STYLE11,
  },
  'ch5-wren-freed': {
