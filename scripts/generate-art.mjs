...
const SCENES = {
  ...
  '0-intro': {
    ...
    prompt: `Cozy sunlit living room. MOM, a golden adult unicorn (lavender mane, small gold heart necklace), is lying down on a comfy couch like a resting horse — a four-legged unicorn with her four legs folded beneath her and her front HOOVES (not hands) resting on the cushion. Her VERY LARGE, round PREGNANT belly is clearly visible (she is heavily pregnant; the big rounded belly is a focus). She has hooves, no arms or hands. IVY (white child unicorn, purple mane, wings) beaming with excitement beside the couch. OLIVER (green child dragon, orange spots, orange heart chest patch) gently pressing one ear against Mom's big pregnant belly to listen, curious but a little unsure. Warm afternoon light, tender and joyful.` + SCENE_STYLE,
  },
  '1': {
  ...
  '5B': {
    ...
    prompt: `A tender nighttime moment in warm golden lamplight. DAD — a friendly adult dragon (soft-bodied, NOT muscular and NOT huge, bronzed-green) — sits with a comforting arm around OLIVER. MOM — a full-grown four-legged unicorn (golden coat, lavender mane, gold heart necklace, soft shawl), the SAME adult size as Dad — lies down beside them like a resting horse, her legs folded under her and her HOOVES visible (she has hooves, NOT human legs, feet, or hands). The tiny PINK baby unicorn is nestled against her side, turning calmly toward Oliver with a soft glow. OLIVER (green dragon CHILD, orange spots, orange heart chest patch) is the same size as Ivy — a big kid, NOT a baby — leaning into Dad with a brave little wobbly smile (not crying, no tears). IVY (white unicorn, purple mane, wings) leaning in close. The two grown-ups Mom and Dad are similar in size to each other and clearly bigger than the three little ones. Warm, reassuring, intimate.` + SCENE_STYLE,
  },
  '6': {
