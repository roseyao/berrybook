...
const SCENES = {
  ...
  '5B': {
    ...
    prompt: `A tender nighttime moment in warm golden lamplight. DAD — a friendly adult dragon (soft-bodied, NOT muscular and NOT huge, bronzed-green) — sits with a comforting arm around OLIVER. MOM — a full-grown adult unicorn (golden coat, lavender mane, gold heart necklace, soft shawl), the SAME adult size as Dad (she is a grown adult, NOT small or child-sized) — sits close beside them with the tiny PINK baby unicorn nestled against her, the baby turning calmly toward Oliver with a soft glow. OLIVER (green dragon CHILD, orange spots, orange heart chest patch) is the same size as Ivy — a big kid, NOT a baby — leaning into Dad with a brave little wobbly smile (not crying, no tears). IVY (white unicorn, purple mane, wings) leaning in close. The two grown-ups Mom and Dad are similar in size to each other and clearly bigger than the three little ones. Warm, reassuring, intimate.` + SCENE_STYLE,
  },
  '6': {
