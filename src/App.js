        ...
        },
        {
            ...
            story: {
                start: {
                    ...
                    text: "When Ivy and Oliver wish on a 'backwards star' to skip school and never go to bed, their wish comes true in the silliest way possible! But as their backwards day unfolds, they discover that maybe school and bedtime aren't so bad after all... especially when the alternative is chaos!",
                    choices: [
                        { text: "Start the Adventure!", nextScene: 'scene1' }
                    ]
                },
        ...
        },
        {
            ...
            story: {
                start: {
                    ...
                    text: "When Ivy and Oliver meets the gratitude goblin. They realize that thank yous and helpfulness can mean a lot.",
                    choices: [
                        { text: "Start the Adventure!", nextScene: 'scene1' }
                    ]
                },
