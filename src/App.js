        ...
        },
        {
            ...
            story: {
                ...
                scene1: {
                    ...
                    choices: [
                        { text: "Get the nursery ready", nextScene: 'scene2A' },
                        { text: "Find out what babies are like", nextScene: 'scene2B' }
                    ]
                },
                scene2A: {
                    title: "Getting Ready",
                    ...
                    choices: [
                        { text: "Be brave and wave goodbye", nextScene: 'scene3A' },
                        { text: "Feel sad that Mom is leaving", nextScene: 'scene3B' }
                    ]
                },
                scene2B: {
                ...
                scene4: {
                    ...
                    choices: [
                        { text: "Jump in and help", nextScene: 'scene5A' },
                        { text: "Tell Mom and Dad how you feel", nextScene: 'scene5B' }
                    ]
                },
                scene5A: {
                    title: "The Helpers",
        ...
        },
        {
            ...
            story: {
                ...
                scene1: {
                    ...
                    choices: [
                        { text: "Ask the tree what changed", nextScene: 'scene2A' },
                        { text: "Go inside to see baby Hazel", nextScene: 'scene2B' }
                    ]
                },
                scene2A: {
                    ...
                    choices: [
                        { text: "Oliver stomps off feeling angry", nextScene: 'scene3A' },
                        { text: "Ivy tries to fix the song", nextScene: 'scene3B' }
                    ]
                },
                scene2B: {
                    ...
                    choices: [
                        { text: "Oliver wanders off feeling something big", nextScene: 'scene3A' },
                        { text: "Ivy decides to be the perfect helper", nextScene: 'scene3B' }
                    ]
                },
                scene3A: {
                ...
                scene4: {
                    ...
                    choices: [
                        { text: "Tell Mom and Dad now", nextScene: 'scene5A' },
                        { text: "Hold it in just a little longer", nextScene: 'scene5B' }
                    ]
                },
                scene5A: {
        ...
        },
        {
            ...
            story: {
                ...
                scene1: {
                    ...
                    choices: [
                        { text: "Follow the map immediately, plans be darned", nextScene: 'scene2A' },
                        { text: "Plan how to split the treasure first", nextScene: 'scene2B' }
                    ]
                },
                scene2A: {
                    ...
                    choices: [
                        { text: "Look around for Princess Pout's treasure first", nextScene: 'scene3A' },
                        { text: "Follow the smell of the royal feast", nextScene: 'scene3B' }
                    ]
                },
                scene2B: {
                ...
                scene4: {
                    ...
                    choices: [
                        { text: "Deny they're really like that", nextScene: 'scene5A' },
                        { text: "Admit they whine a lot", nextScene: 'scene5B' }
                    ]
                },
                scene5A: {
...
const StoryViewer = ({ book, onExit }) => {
    const [currentScene, setCurrentScene] = useState(() => {
        ...
        return book.story[candidate] ? candidate : 'start';
    });
    ...
    useEffect(() => {
        const onPop = () => {
            const { scene } = readURL();
            const next = scene && book.story[scene] ? scene : 'start';
    ...
    const handleChoice = (nextScene) => {
        stopPlayback();
        setErrorMessage('');
        setCurrentScene(storyData[nextScene] ? nextScene : 'start');
    };
