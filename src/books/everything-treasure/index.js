const book = {
    ...
    scenes: {
        ...
        scene1: {
            ...
            text: "Just as Mom finally got Hazel down for a nap, a dusty old map fluttered out from behind a picture frame on the wall and landed right at Ivy's hooves. \"WHAT is that?\" Oliver gasped. They unrolled it carefully. It showed a winding path through the Whispering Wood, leading to something marked: \"ULTIMATE TREASURE — WARNING: CURSED IF FOUGHT OVER.\" \"Real treasure!\" they whispered, eyes huge. \"Maybe we'll finally get something FAIR!\" Ivy declared. \"Without any whining about who gets what!\" Oliver agreed. They snuck out the back door while Mom rocked the baby — already secretly, both of them, planning how to grab the bigger half.",
            choices: [
        ...
        scene6: {
            ...
            text: "\"Let's TRY,\" Ivy said. \"Really try.\" When Oliver found a tarnished coin, instead of wanting one too, Ivy cheered: \"WOW! That's the SHINIEST one!\" The coin BLAZED with light — and a matching one appeared at Ivy's hooves. When Ivy found a crystal that hummed a song, Oliver said: \"That's SO cool! Play us a tune!\" A tiny harmonizing crystal appeared at Oliver's feet. As they kept celebrating each other, the gray rolled back across the whole kingdom — color flooded into Princess Pout's toys, warmth into Duke Grumble's feast, and even Captain Grumble-Beard's dull trinkets started gleaming GOLD. \"Take these,\" he said warmly, pressing a small golden COMPASS into each of their hooves and claws. \"These point toward treasure. But I think you already know the real secret.\" They raced home through the Whispering Wood, even the trees seeming brighter.",
            choices: [
        ...
        scene7: {
            ...
            text: "They burst through the cottage door just as Mom and Dad were reading baby Hazel a bedtime story. Their old selves would have whined \"NOT FAIR she gets a story!\" Instead: \"Hazel's getting a story! That's so NICE!\" Ivy said, and meant it. \"Can we help read?\" Oliver added. Soon all five were piled together — Ivy reading words, Oliver doing the funny voices, Dad doing the sound effects, Mom laughing, Hazel giggling at everything. Their compasses spun wildly, then pointed straight at the family pile. \"Found it,\" they whispered together. \"The best treasure of all.\"",
            choices: [
